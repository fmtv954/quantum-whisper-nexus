 ...
 * Handles microphone access, PCM encoding, and real-time audio streaming
 */
...
/**
 * Encode Float32 audio data to PCM16 base64 for OpenAI Realtime API
 */
...
/**
 * Decode PCM16 base64 from OpenAI to Uint8Array for playback
 */
export const decodeAudioFromAPI = (base64String: string): Uint8Array => {
...
/**
 * Create WAV file from PCM16 data for browser playback
 */
